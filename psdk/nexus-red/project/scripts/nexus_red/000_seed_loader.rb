...
require_relative 'runtime/party_storage'
require_relative 'runtime/portable_pc'
require_relative 'runtime/field_healing'
require_relative 'runtime/kanto_story'
require_relative 'runtime/johto_story'
...
require_relative 'runtime/route_migration_event_adapter'
require_relative 'runtime/wild_battle_launcher'
require_relative 'runtime/wild_battle_results'
require_relative 'runtime/route1_migration_event'
require_relative 'runtime/route2_migration_event'
require_relative 'runtime/route3_migration_event'
