...
Generated seed data is refreshed with `python3 tools/generate_psdk_seed_data.py`, including starter selection, Routes 1-3 encounters, region progression, custom factions, and companion registry.
