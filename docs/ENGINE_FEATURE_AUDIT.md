...
| Pokemon Nexus Red title identity | project_code_needed | First build should stop presenting as generic Emerald as early as practical; placeholder is acceptable. |
