...
pre_bugsy_battle = NexusRed::JohtoStory.complete_bugsy_hive_badge_battle(NexusRed::RuntimeState.build)
raise 'expected JohtoStory Bugsy battle gated before Johto unlock' unless pre_bugsy_battle['status'] == 'blocked_missing_johto_region_unlock'
johto_before_bugsy_prep = NexusRed::RuntimeState.build
johto_before_bugsy_prep['current_region'] = 'johto'
NexusRed::JohtoStory.complete_new_bark_arrival(johto_before_bugsy_prep)
NexusRed::JohtoStory.complete_violet_city_path(johto_before_bugsy_prep)
NexusRed::JohtoStory.complete_sprout_tower_entry(johto_before_bugsy_prep)
NexusRed::JohtoStory.complete_falkner_zephyr_badge_prep(johto_before_bugsy_prep)
NexusRed::JohtoStory.complete_falkner_zephyr_badge_battle(johto_before_bugsy_prep)
NexusRed::JohtoStory.complete_union_cave_road(johto_before_bugsy_prep)
NexusRed::JohtoStory.complete_slowpoke_well_crisis(johto_before_bugsy_prep)
raise 'expected JohtoStory Bugsy battle gated before prep' unless NexusRed::JohtoStory.complete_bugsy_hive_badge_battle(johto_before_bugsy_prep)['status'] == 'blocked_missing_bugsy_hive_badge_prep'
bugsy_battle = NexusRed::JohtoStory.complete_bugsy_hive_badge_battle(
  kanto_story_state,
  location: 'Azalea Gym',
  result: 'won',
  area_type: 'gym'
)
raise 'expected JohtoStory Bugsy battle clear status' unless bugsy_battle['status'] == 'cleared'
raise 'expected JohtoStory Bugsy battle event recorded' unless kanto_story_state['johto_story']['cleared_events'].include?('bugsy_hive_badge_battle')
raise 'expected JohtoStory Bugsy battle helper true' unless NexusRed::JohtoStory.bugsy_hive_badge_battle_cleared?(kanto_story_state)
raise 'expected JohtoStory Hive Badge event recorded' unless kanto_story_state['johto_story']['cleared_events'].include?('hive_badge_obtained')
raise 'expected JohtoStory Ilex Forest unlocked event' unless kanto_story_state['johto_story']['cleared_events'].include?('ilex_forest_path_unlocked')
raise 'expected JohtoStory Hive Badge flag' unless kanto_story_state['story_flags'].include?('hive_badge_obtained')
raise 'expected JohtoStory Nexus Hive flag' unless kanto_story_state['story_flags'].include?('FLAG_NEXUS_HIVE_BADGE')
raise 'expected JohtoStory Bugsy battle started flag' unless kanto_story_state['story_flags'].include?('FLAG_NEXUS_BUGSY_BATTLE_STARTED')
raise 'expected JohtoStory Bugsy battle finished flag' unless kanto_story_state['story_flags'].include?('FLAG_NEXUS_BUGSY_BATTLE_FINISHED')
raise 'expected JohtoStory Red post Bugsy flag' unless kanto_story_state['story_flags'].include?('FLAG_NEXUS_RED_POST_BUGSY')
raise 'expected JohtoStory Brock post Bugsy flag' unless kanto_story_state['story_flags'].include?('FLAG_NEXUS_BROCK_POST_BUGSY')
raise 'expected JohtoStory Bill Hive signal decoded flag' unless kanto_story_state['story_flags'].include?('FLAG_NEXUS_BILL_HIVE_SIGNAL_DECODED')
raise 'expected JohtoStory Ilex Forest path flag' unless kanto_story_state['story_flags'].include?('FLAG_NEXUS_ILEX_FOREST_PATH_UNLOCKED')
raise 'expected JohtoStory current act Ilex' unless kanto_story_state['johto_story']['current_act'] == 'act_7_ilex_forest_and_goldenrod_road'
raise 'expected JohtoStory Red post Bugsy scene' unless kanto_story_state['companion_progress']['red']['scene_flags'].include?('post_bugsy_respect')
raise 'expected JohtoStory Brock post Bugsy scene' unless kanto_story_state['companion_progress']['brock']['scene_flags'].include?('post_bugsy_recovery_review')
raise 'expected JohtoStory Bill Hive decode scene' unless kanto_story_state['companion_progress']['bill']['scene_flags'].include?('hive_signal_decode')
raise 'expected JohtoStory Silver Ilex race activity' unless kanto_story_state['rival_progress']['silver']['latest_activity']['summary'].include?('Silver') && kanto_story_state['rival_progress']['silver']['latest_activity']['summary'].include?('Ilex')
raise 'expected JohtoStory Moonlight spore collapse activity' unless kanto_story_state['faction_progress']['team_moonlight']['region_activity']['johto'].any? { |activity| activity['operation'] == 'dream_spore_residue_collapse' }
raise 'expected JohtoStory Rocket Ilex retreat activity' unless kanto_story_state['faction_progress']['team_rocket']['region_activity']['johto'].any? { |activity| activity['operation'] == 'ilex_cut_through_retreat' }
raise 'expected JohtoStory Gold Dust Ilex relic activity' unless kanto_story_state['faction_progress']['team_gold_dust']['region_activity']['johto'].any? { |activity| activity['operation'] == 'ilex_charcoal_relic_bid' }
raise 'expected JohtoStory Nexus Order Hive badge activity' unless kanto_story_state['faction_progress']['nexus_order']['region_activity']['johto'].any? { |activity| activity['operation'] == 'hive_badge_pattern_hidden' }
raise 'expected JohtoStory Nexus Order still hidden after Bugsy battle' if kanto_story_state['faction_progress']['nexus_order']['revealed']
raise 'expected JohtoStory Bugsy battle story alert immediate' unless kanto_story_state['worldlink_recent_messages'].any? { |message| message['source'] == 'johto_story' && message['text'].include?('Hive Badge') && message['text'].include?('Ilex Forest') && message['text'].include?('Red') }
raise 'expected JohtoStory Bugsy battle result won' unless bugsy_battle['result'] == 'won'
raise 'expected JohtoStory Bugsy battle badge' unless bugsy_battle['badge'] == 'Hive Badge'
raise 'expected JohtoStory Bugsy battle next hook Ilex' unless bugsy_battle['next_hook'] == 'ilex_forest_path'
raise 'expected JohtoStory Bugsy battle current act' unless bugsy_battle['current_act'] == 'act_7_ilex_forest_and_goldenrod_road'
raise 'expected JohtoStory Bugsy battle no companion assist' unless bugsy_battle['companion_rule'] == 'no_companion_assist_in_gym_battle'
raise 'expected JohtoStory Bugsy battle unlocks Ilex and rematch' unless bugsy_battle['unlocks'].include?('ilex_forest_path') && bugsy_battle['unlocks'].include?('bugsy_rematch_board_tier_1')
...
pre_whitney_prep = NexusRed::JohtoStory.complete_whitney_plain_badge_prep(NexusRed::RuntimeState.build)
raise 'expected JohtoStory Whitney prep gated before Johto unlock' unless pre_whitney_prep['status'] == 'blocked_missing_johto_region_unlock'
johto_before_goldenrod = NexusRed::RuntimeState.build
johto_before_goldenrod['current_region'] = 'johto'
NexusRed::JohtoStory.complete_new_bark_arrival(johto_before_goldenrod)
NexusRed::JohtoStory.complete_violet_city_path(johto_before_goldenrod)
NexusRed::JohtoStory.complete_sprout_tower_entry(johto_before_goldenrod)
NexusRed::JohtoStory.complete_falkner_zephyr_badge_prep(johto_before_goldenrod)
NexusRed::JohtoStory.complete_falkner_zephyr_badge_battle(johto_before_goldenrod)
NexusRed::JohtoStory.complete_union_cave_road(johto_before_goldenrod)
NexusRed::JohtoStory.complete_slowpoke_well_crisis(johto_before_goldenrod)
NexusRed::JohtoStory.complete_bugsy_hive_badge_prep(johto_before_goldenrod)
NexusRed::JohtoStory.complete_bugsy_hive_badge_battle(johto_before_goldenrod)
NexusRed::JohtoStory.complete_ilex_forest_path(johto_before_goldenrod)
raise 'expected JohtoStory Whitney prep gated before Goldenrod road' unless NexusRed::JohtoStory.complete_whitney_plain_badge_prep(johto_before_goldenrod)['status'] == 'blocked_missing_goldenrod_road'
whitney_prep = NexusRed::JohtoStory.complete_whitney_plain_badge_prep(
  kanto_story_state,
  location: 'Goldenrod Gym Plaza',
  area_type: 'town'
)
raise 'expected JohtoStory Whitney prep clear status' unless whitney_prep['status'] == 'cleared'
raise 'expected JohtoStory Whitney prep event recorded' unless kanto_story_state['johto_story']['cleared_events'].include?('whitney_plain_badge_prep')
raise 'expected JohtoStory Whitney prep helper true' unless NexusRed::JohtoStory.whitney_plain_badge_prep_cleared?(kanto_story_state)
raise 'expected JohtoStory Whitney rollout training event' unless kanto_story_state['johto_story']['cleared_events'].include?('whitney_rollout_counter_training')
raise 'expected JohtoStory Whitney gym battle unlocked event' unless kanto_story_state['johto_story']['cleared_events'].include?('whitney_plain_badge_battle_unlocked')
raise 'expected JohtoStory Whitney prep flag' unless kanto_story_state['story_flags'].include?('FLAG_NEXUS_WHITNEY_PLAIN_BADGE_PREP')
raise 'expected JohtoStory Whitney rollout training flag' unless kanto_story_state['story_flags'].include?('FLAG_NEXUS_WHITNEY_ROLLOUT_COUNTER_TRAINING')
raise 'expected JohtoStory Red Whitney prep flag' unless kanto_story_state['story_flags'].include?('FLAG_NEXUS_RED_WHITNEY_PREP')
raise 'expected JohtoStory Brock Whitney prep flag' unless kanto_story_state['story_flags'].include?('FLAG_NEXUS_BROCK_WHITNEY_COUNTER_ADVICE')
raise 'expected JohtoStory Bill Whitney prep flag' unless kanto_story_state['story_flags'].include?('FLAG_NEXUS_BILL_RADIO_TOWER_BADGE_SCAN')
raise 'expected JohtoStory Whitney battle unlock flag' unless kanto_story_state['story_flags'].include?('FLAG_NEXUS_WHITNEY_PLAIN_BADGE_BATTLE_UNLOCKED')
raise 'expected JohtoStory current act Whitney challenge' unless kanto_story_state['johto_story']['current_act'] == 'act_10_whitney_plain_badge_challenge'
raise 'expected JohtoStory Red Whitney scene' unless kanto_story_state['companion_progress']['red']['scene_flags'].include?('whitney_prep_focus')
raise 'expected JohtoStory Brock Whitney scene' unless kanto_story_state['companion_progress']['brock']['scene_flags'].include?('rollout_counter_advice')
raise 'expected JohtoStory Bill badge radio scan scene' unless kanto_story_state['companion_progress']['bill']['scene_flags'].include?('radio_tower_badge_scan')
raise 'expected JohtoStory Whitney Silver pressure activity' unless kanto_story_state['rival_progress']['silver']['latest_activity']['summary'].include?('Whitney') && kanto_story_state['rival_progress']['silver']['latest_activity']['summary'].include?('Plain Badge')
raise 'expected JohtoStory Whitney Blue advice activity' unless kanto_story_state['rival_progress']['blue']['latest_activity']['summary'].include?('Miltank')
raise 'expected JohtoStory Rocket Whitney radio activity' unless kanto_story_state['faction_progress']['team_rocket']['region_activity']['johto'].any? { |activity| activity['operation'] == 'plain_badge_radio_sync' && activity['location'] == 'Goldenrod Radio Tower' }
raise 'expected JohtoStory Gold Dust Whitney betting activity' unless kanto_story_state['faction_progress']['team_gold_dust']['region_activity']['johto'].any? { |activity| activity['operation'] == 'whitney_match_betting_ring' }
raise 'expected JohtoStory Team Gas Whitney underground activity' unless kanto_story_state['faction_progress']['team_gas']['region_activity']['johto'].any? { |activity| activity['operation'] == 'gym_basement_vent_pressure' }
raise 'expected JohtoStory Moonlight Whitney jingle activity' unless kanto_story_state['faction_progress']['team_moonlight']['region_activity']['johto'].any? { |activity| activity['operation'] == 'plain_badge_sleep_jingle' }
raise 'expected JohtoStory Nexus Order Whitney pattern activity' unless kanto_story_state['faction_progress']['nexus_order']['region_activity']['johto'].any? { |activity| activity['operation'] == 'plain_badge_frequency_hidden' }
raise 'expected JohtoStory Rocket Moonlight Whitney conflict' unless kanto_story_state['faction_progress']['team_rocket']['conflicts'].any? { |conflict| conflict['opponent'] == 'team_moonlight' && conflict['location'] == 'Goldenrod Radio Tower' }
raise 'expected JohtoStory Nexus Order still hidden after Whitney prep' if kanto_story_state['faction_progress']['nexus_order']['revealed']
raise 'expected JohtoStory Whitney prep story alert immediate' unless kanto_story_state['worldlink_recent_messages'].any? { |message| message['source'] == 'johto_story' && message['text'].include?('Whitney') && message['text'].include?('Miltank') && message['text'].include?('Radio Tower') }
raise 'expected JohtoStory Whitney prep next hook battle' unless whitney_prep['next_hook'] == 'whitney_plain_badge_battle'
raise 'expected JohtoStory Whitney prep level cap' unless whitney_prep['level_cap'] == 26
raise 'expected JohtoStory Whitney prep battle hook id' unless whitney_prep['battle_hook']['battle_id'] == 'whitney_plain_badge_battle'
raise 'expected JohtoStory Whitney no companion gym assist' unless whitney_prep['battle_hook']['companion_rule'] == 'no_companion_assist_in_gym_battle'
raise 'expected JohtoStory Whitney standard team Miltank ace' unless whitney_prep['battle_hook']['standard_team'].any? { |member| member['species'] == 'Miltank' && member['role'] == 'ace' }
raise 'expected JohtoStory Whitney hard team Clefairy support' unless whitney_prep['battle_hook']['hard_team'].any? { |member| member['species'] == 'Clefairy' && member['role'] == 'support' }
raise 'expected JohtoStory Whitney prep unlocks' unless whitney_prep['unlocks'].include?('whitney_plain_badge_battle') && whitney_prep['unlocks'].include?('goldenrod_gym_services') && whitney_prep['unlocks'].include?('rollout_counter_training')
raise 'expected JohtoStory Whitney prep companions' unless %w[red brock bill].all? { |companion| whitney_prep['companions'].include?(companion) }
raise 'expected JohtoStory Whitney prep rivals' unless %w[blue silver].all? { |rival| whitney_prep['rivals'].include?(rival) }
raise 'expected JohtoStory Whitney prep factions' unless %w[team_rocket team_gold_dust team_gas team_moonlight nexus_order].all? { |faction| whitney_prep['factions'].include?(faction) }
...
pre_radio_tower_shadow = NexusRed::JohtoStory.complete_goldenrod_radio_tower_shadow(NexusRed::RuntimeState.build)
raise 'expected JohtoStory Radio Tower shadow gated before Johto unlock' unless pre_radio_tower_shadow['status'] == 'blocked_missing_johto_region_unlock'
johto_before_whitney_battle = NexusRed::RuntimeState.build
johto_before_whitney_battle['current_region'] = 'johto'
NexusRed::JohtoStory.complete_new_bark_arrival(johto_before_whitney_battle)
NexusRed::JohtoStory.complete_violet_city_path(johto_before_whitney_battle)
NexusRed::JohtoStory.complete_sprout_tower_entry(johto_before_whitney_battle)
NexusRed::JohtoStory.complete_falkner_zephyr_badge_prep(johto_before_whitney_battle)
NexusRed::JohtoStory.complete_falkner_zephyr_badge_battle(johto_before_whitney_battle)
NexusRed::JohtoStory.complete_union_cave_road(johto_before_whitney_battle)
NexusRed::JohtoStory.complete_slowpoke_well_crisis(johto_before_whitney_battle)
NexusRed::JohtoStory.complete_bugsy_hive_badge_prep(johto_before_whitney_battle)
NexusRed::JohtoStory.complete_bugsy_hive_badge_battle(johto_before_whitney_battle)
NexusRed::JohtoStory.complete_ilex_forest_path(johto_before_whitney_battle)
NexusRed::JohtoStory.complete_goldenrod_road(johto_before_whitney_battle)
NexusRed::JohtoStory.complete_whitney_plain_badge_prep(johto_before_whitney_battle)
raise 'expected JohtoStory Radio Tower shadow gated before Whitney battle' unless NexusRed::JohtoStory.complete_goldenrod_radio_tower_shadow(johto_before_whitney_battle)['status'] == 'blocked_missing_whitney_plain_badge_battle'
radio_tower_shadow = NexusRed::JohtoStory.complete_goldenrod_radio_tower_shadow(
  kanto_story_state,
  location: 'Goldenrod Radio Tower',
  area_type: 'villain_hideout'
)
raise 'expected JohtoStory Radio Tower shadow clear status' unless radio_tower_shadow['status'] == 'cleared'
raise 'expected JohtoStory Radio Tower shadow event recorded' unless kanto_story_state['johto_story']['cleared_events'].include?('goldenrod_radio_tower_shadow')
raise 'expected JohtoStory Radio Tower shadow helper true' unless NexusRed::JohtoStory.goldenrod_radio_tower_shadow_cleared?(kanto_story_state)
raise 'expected JohtoStory Radio Tower lockdown event' unless kanto_story_state['johto_story']['cleared_events'].include?('radio_tower_lockdown')
raise 'expected JohtoStory Radio Tower lobby battle unlocked event' unless kanto_story_state['johto_story']['cleared_events'].include?('radio_tower_lobby_battle_unlocked')
raise 'expected JohtoStory Underground warehouse lead event' unless kanto_story_state['johto_story']['cleared_events'].include?('goldenrod_underground_warehouse_lead')
raise 'expected JohtoStory Radio Tower shadow flag' unless kanto_story_state['story_flags'].include?('FLAG_NEXUS_GOLDENROD_RADIO_TOWER_SHADOW')
raise 'expected JohtoStory Radio Tower lockdown flag' unless kanto_story_state['story_flags'].include?('FLAG_NEXUS_RADIO_TOWER_LOCKDOWN')
raise 'expected JohtoStory Radio Tower lobby battle flag' unless kanto_story_state['story_flags'].include?('FLAG_NEXUS_RADIO_TOWER_LOBBY_BATTLE_UNLOCKED')
raise 'expected JohtoStory Underground warehouse lead flag' unless kanto_story_state['story_flags'].include?('FLAG_NEXUS_GOLDENROD_UNDERGROUND_WAREHOUSE_LEAD')
raise 'expected JohtoStory current act Radio Tower lockdown' unless kanto_story_state['johto_story']['current_act'] == 'act_12_radio_tower_lockdown'
raise 'expected JohtoStory Red Radio Tower entry scene' unless kanto_story_state['companion_progress']['red']['scene_flags'].include?('radio_tower_entry_guard')
raise 'expected JohtoStory Bill broadcast jam scene' unless kanto_story_state['companion_progress']['bill']['scene_flags'].include?('broadcast_jam_decode')
raise 'expected JohtoStory Blue crowd control scene' unless kanto_story_state['companion_progress']['blue']['scene_flags'].include?('radio_tower_crowd_control')
raise 'expected JohtoStory Silver side door activity' unless kanto_story_state['rival_progress']['silver']['latest_activity']['summary'].include?('side door') && kanto_story_state['rival_progress']['silver']['latest_activity']['summary'].include?('Radio Tower')
raise 'expected JohtoStory Ava broadcast clue activity' unless kanto_story_state['rival_progress']['ava']['latest_activity']['summary'].include?('broadcast') && kanto_story_state['rival_progress']['ava']['latest_activity']['summary'].include?('Goldenrod')
raise 'expected JohtoStory Rocket lobby takeover activity' unless kanto_story_state['faction_progress']['team_rocket']['region_activity']['johto'].any? { |activity| activity['operation'] == 'radio_tower_lobby_takeover' && activity['location'] == 'Goldenrod Radio Tower Lobby' }
raise 'expected JohtoStory Gold Dust ad buy activity' unless kanto_story_state['faction_progress']['team_gold_dust']['region_activity']['johto'].any? { |activity| activity['operation'] == 'radio_tower_ad_buy_laundering' }
raise 'expected JohtoStory Team Gas generator vent activity' unless kanto_story_state['faction_progress']['team_gas']['region_activity']['johto'].any? { |activity| activity['operation'] == 'radio_tower_generator_vent_pressure' }
raise 'expected JohtoStory Moonlight broadcast hypnosis activity' unless kanto_story_state['faction_progress']['team_moonlight']['region_activity']['johto'].any? { |activity| activity['operation'] == 'broadcast_hypnosis_leak' }
raise 'expected JohtoStory Nexus Order transmitter pattern activity' unless kanto_story_state['faction_progress']['nexus_order']['region_activity']['johto'].any? { |activity| activity['operation'] == 'radio_tower_transmitter_pattern_hidden' }
raise 'expected JohtoStory Rocket Gold Dust Radio Tower conflict' unless kanto_story_state['faction_progress']['team_rocket']['conflicts'].any? { |conflict| conflict['opponent'] == 'team_gold_dust' && conflict['location'] == 'Goldenrod Radio Tower Lobby' }
raise 'expected JohtoStory Team Gas Moonlight generator conflict' unless kanto_story_state['faction_progress']['team_gas']['conflicts'].any? { |conflict| conflict['opponent'] == 'team_moonlight' && conflict['location'] == 'Goldenrod Radio Tower Generator Room' }
raise 'expected JohtoStory Nexus Order still hidden after Radio Tower shadow' if kanto_story_state['faction_progress']['nexus_order']['revealed']
raise 'expected JohtoStory Radio Tower story alert paused in hideout' unless kanto_story_state['worldlink_paused_messages'].any? { |message| message['source'] == 'johto_story' && message['text'].include?('Radio Tower') && message['text'].include?('Rocket') && message['delivery'] == 'paused' }
raise 'expected JohtoStory Radio Tower shadow next hook lobby battle' unless radio_tower_shadow['next_hook'] == 'radio_tower_lobby_battle'
raise 'expected JohtoStory Radio Tower battle hook id' unless radio_tower_shadow['battle_hook']['battle_id'] == 'radio_tower_lobby_battle'
raise 'expected JohtoStory Radio Tower tag battle allowed' unless radio_tower_shadow['battle_hook']['companion_rule'] == 'red_and_blue_tag_allowed_outside_gym'
raise 'expected JohtoStory Radio Tower Rocket pair' unless radio_tower_shadow['battle_hook']['enemy_trainers'].include?('rocket_signal_grunt_pair')
raise 'expected JohtoStory Radio Tower route chain' unless radio_tower_shadow['route_chain'] == ['Goldenrod Gym', 'Goldenrod Radio Tower Lobby', 'Goldenrod Underground Warehouse Lead']
raise 'expected JohtoStory Radio Tower unlocks lobby and warehouse' unless radio_tower_shadow['unlocks'].include?('radio_tower_lobby_battle') && radio_tower_shadow['unlocks'].include?('goldenrod_underground_warehouse_lead')
raise 'expected JohtoStory Radio Tower companions' unless %w[red blue bill].all? { |companion| radio_tower_shadow['companions'].include?(companion) }
raise 'expected JohtoStory Radio Tower rivals' unless %w[ava silver].all? { |rival| radio_tower_shadow['rivals'].include?(rival) }
raise 'expected JohtoStory Radio Tower factions' unless %w[team_rocket team_gold_dust team_gas team_moonlight nexus_order].all? { |faction| radio_tower_shadow['factions'].include?(faction) }
...
pre_director_rescue = NexusRed::JohtoStory.complete_radio_tower_director_rescue(NexusRed::RuntimeState.build)
raise 'expected JohtoStory Director rescue gated before Johto unlock' unless pre_director_rescue['status'] == 'blocked_missing_johto_region_unlock'
johto_before_warehouse = NexusRed::RuntimeState.build
johto_before_warehouse['current_region'] = 'johto'
NexusRed::JohtoStory.complete_new_bark_arrival(johto_before_warehouse)
NexusRed::JohtoStory.complete_violet_city_path(johto_before_warehouse)
NexusRed::JohtoStory.complete_sprout_tower_entry(johto_before_warehouse)
NexusRed::JohtoStory.complete_falkner_zephyr_badge_prep(johto_before_warehouse)
NexusRed::JohtoStory.complete_falkner_zephyr_badge_battle(johto_before_warehouse)
NexusRed::JohtoStory.complete_union_cave_road(johto_before_warehouse)
NexusRed::JohtoStory.complete_slowpoke_well_crisis(johto_before_warehouse)
NexusRed::JohtoStory.complete_bugsy_hive_badge_prep(johto_before_warehouse)
NexusRed::JohtoStory.complete_bugsy_hive_badge_battle(johto_before_warehouse)
NexusRed::JohtoStory.complete_ilex_forest_path(johto_before_warehouse)
NexusRed::JohtoStory.complete_goldenrod_road(johto_before_warehouse)
NexusRed::JohtoStory.complete_whitney_plain_badge_prep(johto_before_warehouse)
NexusRed::JohtoStory.complete_whitney_plain_badge_battle(johto_before_warehouse)
NexusRed::JohtoStory.complete_goldenrod_radio_tower_shadow(johto_before_warehouse)
NexusRed::JohtoStory.complete_radio_tower_lobby_battle(johto_before_warehouse)
raise 'expected JohtoStory Director rescue gated before warehouse' unless NexusRed::JohtoStory.complete_radio_tower_director_rescue(johto_before_warehouse)['status'] == 'blocked_missing_goldenrod_underground_warehouse'
director_rescue = NexusRed::JohtoStory.complete_radio_tower_director_rescue(
  kanto_story_state,
  location: 'Goldenrod Underground Holding Room',
  area_type: 'villain_hideout'
)
raise 'expected JohtoStory Director rescue clear status' unless director_rescue['status'] == 'cleared'
raise 'expected JohtoStory Director rescue event recorded' unless kanto_story_state['johto_story']['cleared_events'].include?('radio_tower_director_rescue')
raise 'expected JohtoStory Director rescue helper true' unless NexusRed::JohtoStory.radio_tower_director_rescue_cleared?(kanto_story_state)
raise 'expected JohtoStory Director safe event' unless kanto_story_state['johto_story']['cleared_events'].include?('radio_tower_director_safe')
raise 'expected JohtoStory executive floor unlocked event' unless kanto_story_state['johto_story']['cleared_events'].include?('radio_tower_executive_floor_unlocked')
raise 'expected JohtoStory Director rescue flag' unless kanto_story_state['story_flags'].include?('FLAG_NEXUS_RADIO_TOWER_DIRECTOR_RESCUE')
raise 'expected JohtoStory card key shutter flag' unless kanto_story_state['story_flags'].include?('FLAG_NEXUS_CARD_KEY_SHUTTER_UNLOCK')
raise 'expected JohtoStory executive floor unlocked flag' unless kanto_story_state['story_flags'].include?('FLAG_NEXUS_RADIO_TOWER_EXECUTIVE_FLOOR_UNLOCKED')
raise 'expected JohtoStory current act executive floor' unless kanto_story_state['johto_story']['current_act'] == 'act_15_radio_tower_executive_floor'
raise 'expected JohtoStory Red director rescue guard scene' unless kanto_story_state['companion_progress']['red']['scene_flags'].include?('director_rescue_guard')
raise 'expected JohtoStory Blue rejoins tower climb scene' unless kanto_story_state['companion_progress']['blue']['scene_flags'].include?('rejoins_tower_climb')
raise 'expected JohtoStory Bill transmitter key decode scene' unless kanto_story_state['companion_progress']['bill']['scene_flags'].include?('transmitter_key_decode')
raise 'expected JohtoStory Silver executive stairs activity' unless kanto_story_state['rival_progress']['silver']['latest_activity']['summary'].include?('executive stairs') && kanto_story_state['rival_progress']['silver']['latest_activity']['summary'].include?('Rocket')
raise 'expected JohtoStory Ava director testimony activity' unless kanto_story_state['rival_progress']['ava']['latest_activity']['summary'].include?('Director testimony') && kanto_story_state['rival_progress']['ava']['latest_activity']['summary'].include?('Goldenrod')
raise 'expected JohtoStory Rocket impersonation activity' unless kanto_story_state['faction_progress']['team_rocket']['region_activity']['johto'].any? { |activity| activity['operation'] == 'director_impersonation_confirmed' && activity['location'] == 'Goldenrod Underground Holding Room' }
raise 'expected JohtoStory Gold Dust ransom ledger activity' unless kanto_story_state['faction_progress']['team_gold_dust']['region_activity']['johto'].any? { |activity| activity['operation'] == 'ransom_ledger_recovered' }
raise 'expected JohtoStory Team Gas transmitter coolant activity' unless kanto_story_state['faction_progress']['team_gas']['region_activity']['johto'].any? { |activity| activity['operation'] == 'transmitter_coolant_pressure' }
raise 'expected JohtoStory Moonlight director voiceprint activity' unless kanto_story_state['faction_progress']['team_moonlight']['region_activity']['johto'].any? { |activity| activity['operation'] == 'director_voiceprint_echo' }
raise 'expected JohtoStory Nexus Order director signal mask activity' unless kanto_story_state['faction_progress']['nexus_order']['region_activity']['johto'].any? { |activity| activity['operation'] == 'director_signal_mask_hidden' }
raise 'expected JohtoStory Rocket Moonlight broadcast conflict' unless kanto_story_state['faction_progress']['team_rocket']['conflicts'].any? { |conflict| conflict['opponent'] == 'team_moonlight' && conflict['location'] == 'Goldenrod Radio Tower Broadcast Booth' }
raise 'expected JohtoStory Rocket Gold Dust holding room conflict' unless kanto_story_state['faction_progress']['team_rocket']['conflicts'].any? { |conflict| conflict['opponent'] == 'team_gold_dust' && conflict['location'] == 'Goldenrod Underground Holding Room' }
raise 'expected JohtoStory Nexus Order still hidden after Director rescue' if kanto_story_state['faction_progress']['nexus_order']['revealed']
raise 'expected JohtoStory Director rescue story alert paused in hideout' unless kanto_story_state['worldlink_paused_messages'].any? { |message| message['source'] == 'johto_story' && message['text'].include?('Director') && message['text'].include?('Card Key') && message['text'].include?('Radio Tower') && message['delivery'] == 'paused' }
raise 'expected JohtoStory Director rescue route chain' unless director_rescue['route_chain'] == ['Goldenrod Underground Holding Room', 'Radio Tower Shutter', 'Radio Tower Executive Floor']
raise 'expected JohtoStory Director rescue hidden meta signal' unless director_rescue['hidden_meta_signal'] == 'nexus_order_director_signal_mask_unrevealed'
raise 'expected JohtoStory Director rescue recovered card key' unless director_rescue['recovered_items'].include?('Card Key') && director_rescue['recovered_items'].include?('Director Testimony')
raise 'expected JohtoStory Director rescue battle hook id' unless director_rescue['battle_hook']['battle_id'] == 'radio_tower_shutter_admin_battle'
raise 'expected JohtoStory Director rescue companion rule' unless director_rescue['battle_hook']['companion_rule'] == 'red_and_blue_tag_allowed_outside_gym'
raise 'expected JohtoStory Director rescue unlocks executive floor' unless director_rescue['unlocks'].include?('radio_tower_executive_floor') && director_rescue['unlocks'].include?('card_key_shutter')
raise 'expected JohtoStory Director rescue next hook executive floor' unless director_rescue['next_hook'] == 'radio_tower_executive_floor'
raise 'expected JohtoStory Director rescue companions' unless %w[red blue bill].all? { |companion| director_rescue['companions'].include?(companion) }
raise 'expected JohtoStory Director rescue rivals' unless %w[ava silver].all? { |rival| director_rescue['rivals'].include?(rival) }
raise 'expected JohtoStory Director rescue factions' unless %w[team_rocket team_gold_dust team_gas team_moonlight nexus_order].all? { |faction| director_rescue['factions'].include?(faction) }
