...
func trigger_route_3_entry() -> void:
	dialogue_label.text = "Red: Route 3 is where the last early migration readings spike. Stay sharp; Pewter is close, and Brock will notice if we rush."
