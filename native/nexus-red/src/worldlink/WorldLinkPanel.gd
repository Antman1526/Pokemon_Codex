...
const ROUTE_11_HANDOFF_BATCH_PATH := "res://content/worldlink/route_11_handoff_batch.json"
const DIGLETT_CAVE_DETOUR_BATCH_PATH := "res://content/worldlink/diglett_cave_detour_batch.json"
const ROUTE_2_EAST_FIELD_LAB_BATCH_PATH := "res://content/worldlink/route_2_east_field_lab_batch.json"
const ROUTE_9_ROCK_TUNNEL_APPROACH_BATCH_PATH := "res://content/worldlink/route_9_rock_tunnel_approach_batch.json"
const ROCK_TUNNEL_INTERIOR_BATCH_PATH := "res://content/worldlink/rock_tunnel_interior_batch.json"
const LAVENDER_OUTSKIRTS_BATCH_PATH := "res://content/worldlink/lavender_outskirts_batch.json"
const POKEMON_TOWER_FIRST_FLOOR_BATCH_PATH := "res://content/worldlink/pokemon_tower_first_floor_batch.json"
const POKEMON_TOWER_SILPH_SCOPE_FLOOR_BATCH_PATH := "res://content/worldlink/pokemon_tower_silph_scope_floor_batch.json"
const POKEMON_TOWER_FUJI_RESCUE_BATCH_PATH := "res://content/worldlink/pokemon_tower_fuji_rescue_batch.json"
const ROUTE_12_SNORLAX_WAKE_BATCH_PATH := "res://content/worldlink/route_12_snorlax_wake_batch.json"
const ROUTE_8_CELADON_ROAD_BATCH_PATH := "res://content/worldlink/route_8_celadon_road_batch.json"
const CELADON_UNDERGROUND_PATH_BATCH_PATH := "res://content/worldlink/celadon_underground_path_batch.json"
const CELADON_CITY_ARRIVAL_BATCH_PATH := "res://content/worldlink/celadon_city_arrival_batch.json"
const CELADON_GAME_CORNER_EXTERIOR_BATCH_PATH := "res://content/worldlink/celadon_game_corner_exterior_batch.json"
const CELADON_ROCKET_HIDEOUT_ENTRY_BATCH_PATH := "res://content/worldlink/celadon_rocket_hideout_entry_batch.json"
const CELADON_ROCKET_HIDEOUT_B1F_BATCH_PATH := "res://content/worldlink/celadon_rocket_hideout_b1f_batch.json"
const CELADON_ROCKET_HIDEOUT_B2F_BATCH_PATH := "res://content/worldlink/celadon_rocket_hideout_b2f_batch.json"
const CELADON_ROCKET_HIDEOUT_B3F_BATCH_PATH := "res://content/worldlink/celadon_rocket_hideout_b3f_batch.json"
const CELADON_ROCKET_HIDEOUT_ELEVATOR_BATCH_PATH := "res://content/worldlink/celadon_rocket_hideout_elevator_batch.json"
const CELADON_ROCKET_COMMAND_FLOOR_BATCH_PATH := "res://content/worldlink/celadon_rocket_command_floor_batch.json"
...
func _build_checklist_text() -> String:
	return "Checklist\n%s Visit Oak\n%s Choose first partner\n%s Step onto Route 1\n%s Finish Blue Route 1 battle\n%s Check Route 1 rumors\n%s Reach Viridian City\n%s Talk to Red in Viridian\n%s Find Viridian Rocket clue\n%s Reach Pewter City\n%s Earn Boulder Badge\n%s Investigate Pewter Museum anomaly\n%s Reach Mt. Moon entrance\n%s Witness Rocket and Gold Dust clash\n%s Enter Mt. Moon interior\n%s Map the fossil split paths\n%s Reach fossil decision\n%s Choose Mt. Moon fossil\n%s Reach Route 4\n%s Hear Red's Cerulean warning\n%s Reach Cerulean City\n%s Meet Misty\n%s Identify Nugget Bridge threat\n%s Reach Nugget Bridge\n%s Scout bridge recruiters\n%s Defeat first bridge recruiter\n%s Defeat bridge captain\n%s Clear Nugget Bridge crisis\n%s Challenge Misty's gym\n%s Earn Cascade Badge\n%s Unlock Misty as recurring friend\n%s Reach Route 25\n%s Meet Bill\n%s Decode first Nexus network clue\n%s Investigate Cerulean theft\n%s Recover stolen TM\n%s Unlock Route 5 toward Vermilion\n%s Reach Route 5\n%s Scout Underground Path\n%s Track Vermilion shipping lead\n%s Reach Vermilion City\n%s Scout Vermilion harbor\n%s Find S.S. Anne ticket lead\n%s Tease Surge power sabotage\n%s Reach S.S. Anne ticket office\n%s Check S.S. Anne manifest\n%s Decode Bill's manifest anomaly\n%s Earn S.S. Anne boarding pass\n%s Board S.S. Anne\n%s Spot Blue aboard S.S. Anne\n%s Find Rocket cargo-hold clue\n%s Track Captain's Trail Cutter lead\n%s Battle Blue on S.S. Anne\n%s Earn Blue's ship respect\n%s Enter S.S. Anne cargo hold\n%s Recover Rocket cargo manifest\n%s Spot Nexus Order crate symbol\n%s Unlock Captain path\n%s Reach Captain cabin\n%s Help S.S. Anne Captain\n%s Obtain Trail Cutter\n%s Unlock Lt. Surge gym access\n%s Reach Vermilion power sabotage\n%s Expose Rocket and Team Gas\n%s Prepare with Red and Misty\n%s Unlock Lt. Surge gym battle\n%s Challenge Lt. Surge's gym\n%s Earn Thunder Badge\n%s Unlock Route 11\n%s Reach Route 11\n%s Track Rocket and Team Gas fallout\n%s Decode Route 11 Nexus signal\n%s Tease Snorlax roadblock\n%s Reach Diglett's Cave\n%s Map Diglett's Cave Nexus relay\n%s Confirm Snorlax blocks Route 12\n%s Find Echo Flute lead\n%s Reach Route 2 east field lab\n%s Decode Echo Flute frequency\n%s Trace Rocket and Moonlight sleep signal\n%s Unlock Route 9 toward Rock Tunnel\n%s Reach Route 9\n%s Prepare for Rock Tunnel\n%s Expose Team Moonlight on Route 9\n%s Unlock Rock Tunnel entry\n%s Enter Rock Tunnel\n%s Track Lavender echo\n%s Pressure Team Moonlight in Rock Tunnel\n%s Unlock Lavender exit path\n%s Reach Lavender outskirts\n%s Decode Pokemon Tower signal\n%s Spot Moonlight in Lavender\n%s Unlock Pokemon Tower entry\n%s Enter Pokemon Tower\n%s Decode tower Echo Flute distortion\n%s Find Cubone and Mr. Fuji thread\n%s Lock deeper tower behind Silph Scope\n%s Reach Route 8\n%s Trace Silph Scope toward Celadon\n%s Find Rocket Game Corner lead\n%s Unlock Underground Path to Celadon\n%s Enter Celadon Underground Path\n%s Trace Game Corner signal\n%s Spot Moonlight dream poster\n%s Unlock Celadon City arrival\n%s Reach Celadon City\n%s Scout Game Corner exterior\n%s Spot Moonlight city ad\n%s Tease Erika's gym\n%s Unlock Game Corner investigation\n%s Reach Game Corner exterior\n%s Expose Rocket Game Corner guard\n%s Battle Game Corner guard\n%s Unlock hideout-entry lead\n%s Reach Rocket Hideout entry\n%s Trace hideout elevator signal\n%s Find Lift Key requirement\n%s Hear Giovanni command\n%s Unlock Hideout B1F path\n%s Reach Rocket Hideout B1F\n%s Map Rocket spinner maze\n%s Spot Gold Dust infiltration\n%s Trace Moonlight hideout signal\n%s Unlock Hideout B2F path\n%s Reach Rocket Hideout B2F\n%s Find stolen Silph Scope crate\n%s Battle B2F Rocket patrol\n%s Spot B2F faction conflict\n%s Unlock Hideout B3F path\n%s Reach Rocket Hideout B3F\n%s Trace Nexus Order elevator\n%s Battle B3F Rocket Admin\n%s Obtain Rocket Lift Key\n%s Unlock Hideout elevator path\n%s Reach Rocket Hideout elevator\n%s Decode Nexus Order elevator override\n%s Restore Rocket elevator panel\n%s Find Giovanni command floor route\n%s Unlock Rocket command floor\n%s Reach Rocket command floor\n%s Find Nexus Order command terminal\n%s Face Giovanni in Celadon\n%s Battle Giovanni on command floor\n%s Obtain Silph Scope\n%s Unlock Pokemon Tower deeper path\n%s Unlock Erika gym path\n%s Reach Silph Scope floor\n%s Reveal Marowak spirit\n%s Unlock Mr. Fuji rescue path\n%s Unlock Poke Flute lead\n%s Reach Mr. Fuji rescue\n%s Battle Rocket tower guard\n%s Rescue Mr. Fuji\n%s Obtain Poke Flute\n%s Unlock Snorlax wake path\n%s Reach Route 12 Snorlax\n%s Wake Snorlax\n%s Clear Snorlax roadblock\n%s Unlock Route 12 south path" % [
		...
		_checkmark(_flag("route_11_reached")),
		_checkmark(_flag("rocket_gas_route_11_fallout_seen")),
		_checkmark(_flag("bill_route_11_signal_decode_seen")),
		_checkmark(_flag("snorlax_roadblock_teased")),
		_checkmark(_flag("diglett_cave_detour_reached")),
		_checkmark(_flag("bill_diglett_cave_relay_map_seen")),
		_checkmark(_flag("snorlax_route_12_block_confirmed")),
		_checkmark(_flag("echo_flute_lead_seen")),
		_checkmark(_flag("route_2_east_field_lab_reached")),
		_checkmark(_flag("bill_echo_flute_decoder_seen")),
		_checkmark(_flag("rocket_moonlight_sleep_signal_seen")),
		_checkmark(_flag("route_9_rock_tunnel_path_unlocked")),
		_checkmark(_flag("route_9_rock_tunnel_approach_reached")),
		_checkmark(_flag("bill_rock_tunnel_darkness_warning_seen")),
		_checkmark(_flag("team_moonlight_route_9_debut_seen")),
		_checkmark(_flag("rock_tunnel_entry_unlocked")),
		_checkmark(_flag("rock_tunnel_interior_reached")),
		_checkmark(_flag("bill_lavender_echo_trace_seen")),
		_checkmark(_flag("team_moonlight_cave_pressure_seen")),
		_checkmark(_flag("lavender_exit_path_unlocked")),
		_checkmark(_flag("lavender_outskirts_reached")),
		_checkmark(_flag("bill_pokemon_tower_signal_decode_seen")),
		_checkmark(_flag("team_moonlight_lavender_presence_seen")),
		_checkmark(_flag("pokemon_tower_entry_unlocked")),
		_checkmark(_flag("pokemon_tower_first_floor_reached")),
		_checkmark(_flag("bill_tower_echo_flute_distortion_seen")),
		_checkmark(_flag("cubone_mr_fuji_thread_seen")),
		_checkmark(_flag("pokemon_tower_deeper_path_locked")),
		_checkmark(_flag("route_8_celadon_road_reached")),
		_checkmark(_flag("bill_silph_scope_celadon_trace_seen")),
		_checkmark(_flag("rocket_celadon_game_corner_lead_seen")),
		_checkmark(_flag("underground_path_to_celadon_unlocked")),
		_checkmark(_flag("celadon_underground_path_reached")),
		_checkmark(_flag("bill_game_corner_signal_trace_seen")),
		_checkmark(_flag("team_moonlight_dream_poster_seen")),
		_checkmark(_flag("celadon_city_arrival_unlocked")),
		_checkmark(_flag("celadon_city_reached")),
		_checkmark(_flag("rocket_game_corner_front_seen")),
		_checkmark(_flag("team_moonlight_celadon_ad_seen")),
		_checkmark(_flag("erika_gym_teased_seen")),
		_checkmark(_flag("game_corner_investigation_unlocked")),
		_checkmark(_flag("game_corner_exterior_reached")),
		_checkmark(_flag("rocket_game_corner_guard_exposed")),
		_checkmark(_flag("rocket_game_corner_guard_battle_finished")),
		_checkmark(_flag("game_corner_hideout_entry_unlocked")),
		_checkmark(_flag("celadon_rocket_hideout_entry_reached")),
		_checkmark(_flag("bill_hideout_elevator_signal_seen")),
		_checkmark(_flag("rocket_lift_key_required_seen")),
		_checkmark(_flag("giovanni_hideout_command_seen")),
		_checkmark(_flag("rocket_hideout_b1f_path_unlocked")),
		_checkmark(_flag("celadon_rocket_hideout_b1f_reached")),
		_checkmark(_flag("rocket_spinner_maze_seen")),
		_checkmark(_flag("gold_dust_hideout_infiltration_seen")),
		_checkmark(_flag("team_moonlight_hideout_signal_bleed_seen")),
		_checkmark(_flag("rocket_hideout_b2f_path_unlocked")),
		_checkmark(_flag("celadon_rocket_hideout_b2f_reached")),
		_checkmark(_flag("bill_stolen_silph_scope_crate_seen")),
		_checkmark(_flag("rocket_hideout_b2f_patrol_battle_finished")),
		_checkmark(_flag("rocket_gold_dust_b2f_conflict_seen")),
		_checkmark(_flag("rocket_hideout_b3f_path_unlocked")),
		_checkmark(_flag("celadon_rocket_hideout_b3f_reached")),
		_checkmark(_flag("bill_nexus_order_elevator_trace_seen")),
		_checkmark(_flag("rocket_admin_lift_key_battle_finished")),
		_checkmark(_flag("rocket_lift_key_obtained")),
		_checkmark(_flag("rocket_hideout_elevator_path_unlocked")),
		_checkmark(_flag("celadon_rocket_hideout_elevator_reached")),
		_checkmark(_flag("bill_nexus_order_elevator_override_seen")),
		_checkmark(_flag("rocket_elevator_panel_restored_seen")),
		_checkmark(_flag("giovanni_command_floor_route_seen")),
		_checkmark(_flag("rocket_command_floor_path_unlocked")),
		_checkmark(_flag("celadon_rocket_command_floor_reached")),
		_checkmark(_flag("bill_nexus_order_command_terminal_seen")),
		_checkmark(_flag("giovanni_first_confrontation_seen")),
		_checkmark(_flag("giovanni_command_floor_battle_finished")),
		_checkmark(_flag("silph_scope_obtained")),
		_checkmark(_flag("pokemon_tower_deeper_path_unlocked")),
		_checkmark(_flag("erika_gym_path_unlocked")),
		_checkmark(_flag("pokemon_tower_silph_scope_floor_reached")),
		_checkmark(_flag("marowak_spirit_revealed")),
		_checkmark(_flag("mr_fuji_rescue_path_unlocked")),
		_checkmark(_flag("poke_flute_lead_unlocked")),
		_checkmark(_flag("pokemon_tower_fuji_rescue_reached")),
		_checkmark(_flag("rocket_tower_fuji_guard_battle_finished")),
		_checkmark(_flag("mr_fuji_rescued")),
		_checkmark(_flag("poke_flute_obtained")),
		_checkmark(_flag("snorlax_wake_path_unlocked")),
		_checkmark(_flag("route_12_snorlax_wake_reached")),
		_checkmark(_flag("snorlax_static_encounter_seen")),
		_checkmark(_flag("snorlax_roadblock_cleared")),
		_checkmark(_flag("route_12_south_path_unlocked")),
	]
...
func _build_item_index() -> Dictionary:
	...
	_add_feed_items(index, ROUTE_11_HANDOFF_BATCH_PATH, "feed")
	_add_feed_items(index, DIGLETT_CAVE_DETOUR_BATCH_PATH, "feed")
	_add_feed_items(index, ROUTE_2_EAST_FIELD_LAB_BATCH_PATH, "feed")
	_add_feed_items(index, ROUTE_9_ROCK_TUNNEL_APPROACH_BATCH_PATH, "feed")
	_add_feed_items(index, ROCK_TUNNEL_INTERIOR_BATCH_PATH, "feed")
	_add_feed_items(index, LAVENDER_OUTSKIRTS_BATCH_PATH, "feed")
	_add_feed_items(index, POKEMON_TOWER_FIRST_FLOOR_BATCH_PATH, "feed")
	_add_feed_items(index, POKEMON_TOWER_SILPH_SCOPE_FLOOR_BATCH_PATH, "feed")
	_add_feed_items(index, POKEMON_TOWER_FUJI_RESCUE_BATCH_PATH, "feed")
	_add_feed_items(index, ROUTE_12_SNORLAX_WAKE_BATCH_PATH, "feed")
	_add_feed_items(index, ROUTE_8_CELADON_ROAD_BATCH_PATH, "feed")
	_add_feed_items(index, CELADON_UNDERGROUND_PATH_BATCH_PATH, "feed")
	_add_feed_items(index, CELADON_CITY_ARRIVAL_BATCH_PATH, "feed")
	_add_feed_items(index, CELADON_GAME_CORNER_EXTERIOR_BATCH_PATH, "feed")
	_add_feed_items(index, CELADON_ROCKET_HIDEOUT_ENTRY_BATCH_PATH, "feed")
	_add_feed_items(index, CELADON_ROCKET_HIDEOUT_B1F_BATCH_PATH, "feed")
	_add_feed_items(index, CELADON_ROCKET_HIDEOUT_B2F_BATCH_PATH, "feed")
	_add_feed_items(index, CELADON_ROCKET_HIDEOUT_B3F_BATCH_PATH, "feed")
	_add_feed_items(index, CELADON_ROCKET_HIDEOUT_ELEVATOR_BATCH_PATH, "feed")
	_add_feed_items(index, CELADON_ROCKET_COMMAND_FLOOR_BATCH_PATH, "feed")
